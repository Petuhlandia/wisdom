...
def compare_stemmer_and_lemmatizer(stemmer, lemmatizer, words, pos):
    """
    Print the results of stemmind and lemmitization using the passed stemmer, lemmatizer, word and pos (part of speech)
    """
    print("Stemmer:", stemmer.stem(words))
    print("Lemmatizer:", lemmatizer.lemmatize(words, pos))
    print()

lemmatizer = WordNetLemmatizer()
stemmer = PorterStemmer()
compare_stemmer_and_lemmatizer(stemmer, lemmatizer, words, pos = wordnet.VERB)
compare_stemmer_and_lemmatizer(stemmer, lemmatizer, words, pos = wordnet.VERB)
